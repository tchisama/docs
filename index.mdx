...
<CardGroup cols={2}>
  ...
  <Card title="New Card" icon="sparkles">
    kjhkjhkjhkjhk kjhkjh kj hkjhkj kjh jkhkj
  </Card>
  <Card title="New Card" icon="sparkles">
    jlj ljl jlkj lkj;lj;lkj lkjlkjlkjlj;l 
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Customize Style" icon="banana" href="https://mintlify.com/docs/settings/global">
